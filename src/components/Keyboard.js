...
class Keyboard extends Component {
    ...
    render() {
        return (
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 12)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 11)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 10)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 9)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 8)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 7)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 6)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 5)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 4)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 3)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 2)}}>
            ...
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid + 1)}}>
            ...
            {/* MIDDLE C */}
            <g className="key" onClick={() => {this.props.onKeyClickHandler(this.state.mid)}}>
