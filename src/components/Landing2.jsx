        ...
        <div className="main" style={{ paddingTop: "200px" }}>
          ...
          <div className="bigButtonHolder">
            ...
            <Button
              ...
              title={"Chords"}
              txt={"How well can you recognize your chords?"}
              img={chord}
            />
            <Button
              onClick={() => {
              ...
              title={"Sandbox"}
              txt={"Learn your scales and chords in an interractive sandbox."}
              img={clef}
            />
          </div>
        </div>
