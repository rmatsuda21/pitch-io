...
class SandboxKeyboard extends Component {
    constructor(props) {
        super(props);
    ...
    keyDownHandler(e) {
        console.log(e.key);
        switch(e.key) {
            case 'a': this.startBlink("-12"); break;
            case 'w': this.startBlink("-11"); break;
            case 's': this.startBlink("-10"); break;
            case 'e': this.startBlink("-9"); break;
            case 'd': this.startBlink("-8"); break;
            case 'f': this.startBlink("-7"); break;
            case 't': this.startBlink("-6"); break;
            case 'g': this.startBlink("-5"); break;
            case 'y': this.startBlink("-4"); break;
            case 'h': this.startBlink("-3"); break;
            case 'u': this.startBlink("-2"); break;
            case 'j': this.startBlink("-1"); break;
            case 'k': this.startBlink("0"); break;
            case 'o': this.startBlink("1"); break;
            case 'l': this.startBlink("2"); break;
            case 'p': this.startBlink("3"); break;
            case ';': this.startBlink("4"); break;
        }
    }
    ...
    startBlink(id) {
        ...
        this.props.onKeyClickHandler(parseInt(id)+60);
    }
    ...
    render() {
        return (
            ...
            <g style={{color:"#CFDEE7"}} id="12" className="key" onClick={() => {this.startBlink(12)}} onAnimationEnd={() => {this.removeBlink(12)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="11" className="key" onClick={() => {this.startBlink(11)}} onAnimationEnd={() => {this.removeBlink(11)}}>
            ...
            <g style={{color:"#92B4F4"}} id="10" className="key" onClick={() => {this.startBlink(10)}} onAnimationEnd={() => {this.removeBlink(10)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="9" className="key" onClick={() => {this.startBlink(9)}} onAnimationEnd={() => {this.removeBlink(9)}}>
            ...
            <g style={{color:"#92B4F4"}} id="8" className="key" onClick={() => {this.startBlink(8)}} onAnimationEnd={() => {this.removeBlink(8)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="7" className="key" onClick={() => {this.startBlink(7)}} onAnimationEnd={() => {this.removeBlink(7)}}>
            ...
            <g style={{color:"#92B4F4"}} id="6" className="key" onClick={() => {this.startBlink(6)}} onAnimationEnd={() => {this.removeBlink(6)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="5" className="key" onClick={() => {this.startBlink(5)}} onAnimationEnd={() => {this.removeBlink(5)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="4" className="key" onClick={() => {this.startBlink(4)}} onAnimationEnd={() => {this.removeBlink(4)}}>
            ...
            <g style={{color:"#92B4F4"}} id="3" className="key" onClick={() => {this.startBlink(3)}} onAnimationEnd={() => {this.removeBlink(3)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="2" className="key" onClick={() => {this.startBlink(2)}} onAnimationEnd={() => {this.removeBlink(2)}}>
            ...
            <g style={{color:"#92B4F4"}} id="1" className="key" onClick={() => {this.startBlink(1)}} onAnimationEnd={() => {this.removeBlink(1)}}>
            ...
            {/* MIDDLE C */}
            <g style={{color:"#CFDEE7"}} id="0" className="key" onClick={() => {this.startBlink(0)}} onAnimationEnd={() => {this.removeBlink(0)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="-1" className="key" onClick={() => {this.startBlink(-1)}} onAnimationEnd={() => {this.removeBlink(-1)}}>
            ...
            <g style={{color:"#92B4F4"}} id="-2" className="key" onClick={() => {this.startBlink(-2)}} onAnimationEnd={() => {this.removeBlink(-2)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="-3" className="key" onClick={() => {this.startBlink(-3)}} onAnimationEnd={() => {this.removeBlink(-3)}}>
            ...
            <g style={{color:"#92B4F4"}} id="-4" className="key" onClick={() => {this.startBlink(-4)}} onAnimationEnd={() => {this.removeBlink(-4)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="-8" className="key" onClick={() => {this.startBlink(-8)}} onAnimationEnd={() => {this.removeBlink(-8)}}>
            ...
            <g style={{color:"#92B4F4"}} id="-9" className="key" onClick={() => {this.startBlink(-9)}} onAnimationEnd={() => {this.removeBlink(-9)}}>
            ...
            <g style={{color:"#CFDEE7"}} id="-10" className="key" onClick={() => {this.startBlink(-10)}} onAnimationEnd={() => {this.removeBlink(-10)}}>
            ...
            <g style={{color:"#92B4F4"}} id="-11" className="key" onClick={() => {this.startBlink(-11)}} onAnimationEnd={() => {this.removeBlink(-11)}}>
...
} export default SandboxKeyboard;